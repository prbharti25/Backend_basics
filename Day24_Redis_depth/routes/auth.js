...
authRouter.post("/logout",userAuth, async(req,res)=>{
    ...
    //    await redisClient.expire(`token:${token}`,1800);  //in seconds from current time
      await redisClient.expireAt(`token:${token}`,payload.exp);     //from 1 jan 1970 to payload.exp (expiry time)
