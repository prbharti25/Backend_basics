...
app.post("/login", async(req,res)=>{
    ...
    try{
        ...
        // jwt token 
        const token = jwt.sign({_id:people._id, emailId:people.emailId},"Pushp@13412$", {expiresIn:100});
                                    //this is payload                   //This is key
...
app.get("/info", async(req,res)=>{
    ...
    try{
       ...
       const payload =  jwt.verify(req.cookies.token,"Pushp@13412$");
